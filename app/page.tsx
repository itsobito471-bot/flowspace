          ...
          {success ? (
            ...
            <motion.form key="form" onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <motion.button type="submit" disabled={loading}
                ...
                style={{ padding: "0.9rem", borderRadius: 10, border: "none", background: accent, color: "#fff", fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 700, fontSize: "0.95rem", cursor: loading ? "wait" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem" }}>
                {loading ? (
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible" style={{ position: "relative", zIndex: 2, maxWidth: 900, padding: "0 2rem" }}>
            ...
            <motion.div variants={fadeUp} style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
              <motion.button onClick={() => router.push("/login")} whileHover={{ scale: 1.05, boxShadow: `0 0 36px ${accent}55` }} whileTap={{ scale: 0.97 }}
                style={{ padding: "0.85rem 2.2rem", borderRadius: 8, border: "none", background: accent, color: "#fff", fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 700, fontSize: "0.95rem", cursor: "pointer" }}>
                Start Free Trial
              </motion.button>
