        ...
        <div className="bg-surface border border-muted/10 rounded-2xl p-4 sm:p-6 lg:p-8 space-y-8">
          ...
          <div className="pt-6 border-t border-muted/10">
            <button
              onClick={handleSave}
              disabled={saving}
              className="btn-brand w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-sm font-bold tracking-tight disabled:cursor-not-allowed"
            >
